...
RUN pip install einx==0.3.0 omegaconf==2.3.0 soundfile==0.12.1 soxr==0.5.0.post1 gradio tritonclient librosa jupyter lameenc -i https://pypi.tuna.tsinghua.edu.cn/simple
WORKDIR /workspace
